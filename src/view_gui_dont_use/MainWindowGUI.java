...
import view_event_dont_use.CreateNewFileEventClick;
import view_event_dont_use.SelectFileEventClick;
import view_event_dont_use.SelectFolderEventClick;
...
public class MainWindowGUI extends JFrame{
	...
	//Enquanto isso use a Main do pacote view_command_line
	/*public static void main(String[] args) {  //Removida nesta versão do compilador, voltará a funcionar no sintatico o/
		new MainWindowGUI(); //Use a #VoltaGUI para que os desenvolvedores (Marcelo) queira trazer a interface de volta
	}*/
